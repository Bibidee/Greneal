...
if "[:12000]" in source or "[:MAX_ARTIFACT_BYTES]" in source:
    raise SystemExit("Semantic artefact slicing is forbidden; accepted artefacts must be reviewed completely")
